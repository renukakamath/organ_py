...
public class Userviewcheckdonationstatus extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_userviewcheckdonationstatus);
       ...
       l1.setOnItemClickListener(this);
        ...
        JR.json_response=(JsonResponse)Userviewcheckdonationstatus.this;
        String q="/userviewdonationstatus?did="+Usersenddonationrequest.dids;
        q=q.replace(" ","%20");
        JR.execute(q);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(Userviewcheckdonationstatus.this);
